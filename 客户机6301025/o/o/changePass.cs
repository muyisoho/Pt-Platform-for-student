    ...
    public partial class changePass : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    servercliention.clientsql = "select * from student where sname='王明'and spassword='" + textBox1.Text.Trim() + "'";
                    ...
                    {
                        servercliention.clientsql = "update student set spassword='" + textBox3.Text.Trim() + "' where sname='王明'";
                        servercliention.cliention();
